...
<div class="jumbotron" style="background-image: url(https://images.pexels.com/photos/1571174/pexels-photo-1571174.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940);margin-top: 0px;">
    <div class="container" style="-webkit-text-fill-color: #2F2F2F">
        <h1><b>Your works professionalized | Simplified</b></h1>
        <h4>Find the professionals for every job. Keep Connect. </h4> 
        <hr class="my-4">
        <table>
            <tr>
                <td style="margin:10px;width:350px"><label for="email"><b>What type of professional you need?</b></label></td>
                <td style="margin:10px;width:350px"><label for="pwd"><b>What type of job it is?</b></label></td>
            ...
            <tr>
                ...
                <td style="margin:10px;width:350px">
                    <div class="form-group">                       
                        <select class="form-control" id="exampleSelect1">
                            <option>External Tiling</option>
                            <option>Internal Tiling</option>
                            <option>Wall Tiling</option>
                            <option>Internal Rendering</option>
                ...
                <td style="margin:10px;width:350px">
                    <div class="form-group">   
                        <button type="button" class="btn btn-primary">Browse <i class='fas fa-angle-right'></i></button>
                    </div>
                </td>
...
<br>
<div class="container">
    <h3 style="text-align: center;color: #110077;font-weight: 500;"><b>Their experienes</b></h3>
    <br>
    @include('pages.index_carousel')
</div>
